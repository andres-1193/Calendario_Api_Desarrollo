...
set rootfolder=D:\ESTUDIO\semestre 1-2024\Software empresarial\unidad 3\entrega 4 -Api_Calendario\Calendario_Api\actions-runner
set existrunnerversion=2.294.0
set downloadrunnerversion=2.317.0
set logfile=D:\ESTUDIO\semestre 1-2024\Software empresarial\unidad 3\entrega 4 -Api_Calendario\Calendario_Api\actions-runner\_diag\SelfUpdate-20240607-042516.log
...
if %restartinteractiverunner% equ 1 (
  ...
  endlocal
  start "Actions Runner" cmd.exe /k "D:\ESTUDIO\semestre 1-2024\Software empresarial\unidad 3\entrega 4 -Api_Calendario\Calendario_Api\actions-runner\run.cmd"
) else (
  endlocal
)
